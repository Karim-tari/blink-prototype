...
const NaveenBackstreetBoysFlow = ({ onComplete }) => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Naveen Backstreet Boys Push Notification */}
        {showNotification && (
          <img 
            src={`${process.env.PUBLIC_URL}/Naveen-Backstreet-Boys/naveen-notifications-backstreetboys.png`}
            onClick={handleNotificationTap}
            alt="Naveen Backstreet Boys Notification"
            style={{
              width: '175%',
              maxWidth: '730px',
              height: 'auto',
...
export default NaveenBackstreetBoysFlow;
