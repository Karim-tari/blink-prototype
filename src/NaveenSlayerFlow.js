...
const NaveenSlayerFlow = ({ onComplete }) => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Naveen Slayer Drop Push Notification */}
        {showNotification && (
          <img 
            src={`${process.env.PUBLIC_URL}/Naveen-Slayer-Drop/naveen notification.png`}
            onClick={handleNotificationTap}
            alt="Naveen Slayer Drop Notification"
            style={{
              width: '175%',
              maxWidth: '730px',
              height: 'auto',
...
export default NaveenSlayerFlow;
